...
{{- $dbprefix = concat "ynjg_" $dbprefix}}
...
insert into ask_help (select * from {{$prefix}}.ask_help where player_id > 0);

#从{{$prefix}}online_data
insert into online_data (select * from {{$prefix}}.online_data where player_id > 0);
